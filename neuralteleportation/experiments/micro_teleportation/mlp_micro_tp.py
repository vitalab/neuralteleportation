...
if __name__ == '__main__':
    ...
    print(test(mlp_model, loss, metrics, test_set))

    dot_product(network=mlp_model, dataset=test_set, network_descriptor='MLP on MNIST')
    ...
    dot_product(network=mlp_model, dataset=test_set, network_descriptor='MLP on CIFAR10')
    ...
    dot_product(network=mlp_model, dataset=test_set, network_descriptor='MLP on CIFAR100')